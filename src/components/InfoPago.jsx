...
import "./Info.css";
import qrmp from "../img/qrjuan.png"
  ...
  return (
    <div>
        <div className='centradoInfo'>
            ...
            <br />
            <div>
              Una vez abonado el 10% de la pagina empezaremos a armar la misma.
              <br />
              <br />
            ...
            <br />
            <br />
            Una vez hecho el pago enviar comprobante por whatsapp al +5491176351958
            <br />
            <div className='fondo'>       
